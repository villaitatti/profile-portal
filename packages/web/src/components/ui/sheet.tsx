  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-background text-sm shadow-lg transition ease-in-out outline-none data-open:animate-in data-open:duration-300 data-closed:animate-out data-closed:duration-200",
          side === "right" &&
